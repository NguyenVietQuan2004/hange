        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">Manage booking services</p>
            </div>
                  ...
                  paginatedServices.map((service, index) => (
                    <tr key={service.id} className="border-t border-border transition hover:bg-accent/40">
                      ...
                      <td className="px-6 py-4 font-medium">
                        <Link href={`/services/${service.slug}`} className="transition hover:text-primary">
                          {service.name}
                        </Link>
                      </td>

                      <td className="px-6 py-4 text-sm text-muted-foreground">{service.categoryName}</td>

                      <td className="px-6 py-4 text-sm text-muted-foreground">{service.durationMinutes} mins</td>

                      <td className="px-6 py-4 text-sm text-muted-foreground">{service.price.toLocaleString()}đ</td>
