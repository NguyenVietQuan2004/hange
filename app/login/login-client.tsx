...
//       router.push("/");
//     } catch (err: any) {
//       if ([ERROR_CODE.AUTH_INVALID_CREDENTIALS, ERROR_CODE.USER_NOT_FOUND].includes(err.message)) {
...
import { authService } from "@/services/auth.service";
import { AppuleIcon, GoogleIcon } from "@/public/icons";
import { LOGIN_ERROR_MESSAGE, LOGIN_RESEND_VERIFICATION_ERRORS } from "@/const/login-error";
import { RESEND_VERIFICATION_ERROR_MESSAGE } from "@/const/resend-verification-error";
