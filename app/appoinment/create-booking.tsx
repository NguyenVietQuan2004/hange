...
//     categories,
//     services,
//     loadingCategories: isLoadingInitial,
//   } = useMasterDataStore(
//     useShallow((state) => ({
...
//                           There are currently no service categories available.
//                         </p>
//                       </div>
//                     )}
//                   </div>
...
//                         <p className="text-sm text-muted-foreground mt-1">This service has no active centers yet.</p>
//                       </div>
//                     ) : (
//                       locations.map((loc) => (
//                         <button
...
//                       </div>
//                     ) : slots.length === 0 ? (
//                       <p className="text-center text-muted-foreground py-12">No available time slots for this date.</p>
//                     ) : (
...
//                               ) : remaining <= 3 ? (
//                                 <span className="text-amber-500 text-xs font-medium mt-1">Only {remaining} left</span>
//                               ) : (
...
export default function CreateBookingPage() {
  ...
  return (
    <main
      // className="min-h-screen bg-background bg-cover bg-center bg-no-repeat bg-transparent"
      className="min-h-screen   bg-cover bg-center bg-no-repeat bg-transparent"
      // style={{
    ...
    >
      ...
      {/* <div className="border-b border-border bg-card"> */}
      <div className=" ">
        <div className="mx-auto max-w-6xl px-4 py-6 text-primary">
          <h1 className="text-4xl font-semibold tracking-tight">Book an Appointment</h1>
          {/* <p className="mt-1 text-muted-foreground">Complete the steps below to schedule your appointment.</p> */}
          <p className="mt-">Complete the steps below to schedule your appointment.</p>
        </div>
      </div>

      <div className="mx-auto max-w-4xl px-4 py-8">
        {/* Progress Steps */}
        <div className="mb-2 overflow-hidden rounded-lg  border-border bg-card px-6 py-4">
          <div className="flex items-center justify-between">
            {STEPS.map((step, index) => {
              const Icon = step.icon;
              const isCompleted = currentStep > step.id;
