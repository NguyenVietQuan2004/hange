...
//   await fetch(API_URL.NEXT_SERVER.LOGOUT, { method: "POST" });
...
//     if (!tokenRes.ok) return forceLogout("Case >>> Cannot get token from next-server");
...
//       if (!tokenData) {
//         return await forceLogout(ERROR_CODE.REFRESH_TOKEN_FAILED);
//       }
